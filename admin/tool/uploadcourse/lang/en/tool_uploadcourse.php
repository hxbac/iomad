...
$string['checkshortname'] = 'Shortname course';
$string['checkshortname_help'] = 'Kiếm tra shortname khóa học khi upload từ file theo tiêu chuẩn: Năm_Kì_Tổ_Môn_Lớp. Ngăn cách bằng dấu _. Ví dụ: 21-22_Kì 1_Tổ tự nhiên_Toán 10_A1';
$string['printerrorcheckshortname'] = 'Bạn đã chọn kiếm tra shortname của khóa học, nó bắt buộc phải theo tiêu chuẩn Năm_Kì_Tổ_Môn_Lớp (bắt buộc 4 dấu "_"). Nếu không muốn kiểm tra shortname, hãy bỏ chọn trong phần tải tệp khóa học.';
$string['printerrornocolumnshortname'] = 'Không tồn tại cột shortname.';
