...
$string['grademethod'] = 'Cách lấy điểm';
...
$string['gradereported'] = 'Điểm đã lưu';
...
$string['highestattempt'] = 'Điểm lần cao nhất';
...
$string['noattemptsallowed'] = 'Số lần học cho phép';
$string['noattemptsmade'] = 'Số lần đã học';
