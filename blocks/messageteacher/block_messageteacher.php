        ...
        if (get_config('block_messageteacher', 'roles')) {
            ...
            if (get_config('block_messageteacher', 'includecoursecat')) {
                ...
                foreach ($parentCategories as $category) {
                    $params = array_merge($params, array($category, CONTEXT_COURSECAT));
            ...
            $this->content->text = "Không có vai trò nào được định nghĩa để hiển thị";
        }
