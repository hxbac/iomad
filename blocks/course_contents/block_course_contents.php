...
class block_course_contents extends block_base {
    ...
    public function get_content() {
        ...
        $text = html_writer::start_tag('ul', array('class' => 'section-list list-group custom-ul-block-course-content'));
        
        $text .=    '<style>
                        body {
                            scroll-behavior: smooth;
                        }
                        .custom-ul-block-course-content {
                            flex-direction: row !important;
                        }    
                        .custom-li-block-course-content {
                            padding: 0 !important;
                            flex: 1;
                            border: unset;
                        }
                        .custom-li-block-course-content:hover {
                            background: #f5f5f5 !important;
                        }
                        .custom-li-block-course-content a {
                            display: block;
        ...
        foreach ($sections as $section) {
            ...
            if (($i == 0) && ($displaycourselink)) {
                $sectionclass = 'section-item list-group-item custom-li-block-course-content';
