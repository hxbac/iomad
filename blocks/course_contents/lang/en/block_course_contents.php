...
$string['config_autotitle'] = 'Tiêu đề tự động';
...
$string['config_autotitle_label'] = 'Tự động trích xuất tiêu đề từ tóm tắt của phần đó.';
$string['config_autotitle_optional_off'] = 'Tùy chọn, tắt theo mặc định';
$string['config_autotitle_optional_on'] = 'Tùy chọn, bật theo mặc định';
$string['config_blocktitle'] = 'Tiêu đề khối';
$string['config_blocktitle_default'] = 'Danh mục môn học';
...
$string['config_enumerate'] = 'Liệt kê các tiêu đề của các phần';
...
$string['config_enumerate_label'] = 'Nếu cho phép, số thứ tự của từng phần sẽ hiển thị trước tiêu đề của phần đó.';
...
$string['pluginname'] = 'Menu nội dung môn học nằm ngang';

$string['config_enumerate_section_0'] = 'Liệt kê phần chung';
...
$string['config_enumerate_section_0_label'] = 'Bắt đầu liệt kê từ phần chung.';

$string['config_display_course_link'] = 'Liên kết trang khóa học';
$string['config_display_course_link_desc'] = 'Hiển thị liên kết trang chủ của khóa học ở đầu tất cả các phần.';
